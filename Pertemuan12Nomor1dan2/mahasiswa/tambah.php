...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_query($conn, $sql)) {
            $_SESSION['message'] = "Data mahasiswa $nama berhasil ditambahkan!";
...
<head>
    ...
    <style>
        ...
        .card-header { background: linear-gradient(135deg, #1a237e, #0d47a1); border-radius: 12px 12px 0 0 !important; color: white; }
        ...
        .photo-preview { width: 100px; height: 100px; object-fit: cover; border-radius: 50%; border: 3px solid #e0e0e0; display: none; }
        .photo-placeholder { width: 100px; height: 100px; border-radius: 50%; background: #e8eaf6; display: flex; align-items: center; justify-content: center; color: #9fa8da; font-size: 2.5rem; }
    </style>
</head>
<body>
...
<div class="container" style="max-width:720px">
    ...
    <div class="card">
        <div class="card-header py-3">
            <h6 class="mb-0"><i class="bi bi-person-plus me-2"></i>Form Tambah Data</h6>
        </div>
        <div class="card-body p-4">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="text-center mb-4">
                    <div class="photo-placeholder mx-auto mb-2" id="photoPlaceholder">
                        <i class="bi bi-camera"></i>
                    </div>
                    <img id="photoPreview" class="photo-preview mx-auto mb-2" src="" alt="Preview">
                    <div>
                        <label class="form-label fw-semibold d-block">Foto Profil <span class="text-muted small">(opsional)</span></label>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nim" class="form-control" placeholder="Contoh: 20230001"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat lengkap (opsional)"><?= htmlspecialchars($_POST['alamat'] ?? '') ?></textarea>
                    </div>
                </div>
